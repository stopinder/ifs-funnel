    ...
    >
      ...
      <header class="text-center mb-10">
        ...
        >
          ...
          regulation and integration — not endless excavation.
          IFS, blended with EMDR-informed attention and reflective
          written follow-up.
        </p>
      </header>
      ...
      <section class="mt-12 space-y-4">
        ...
        <p class="text-base md:text-lg leading-relaxed text-textsurface">
          ...
          the younger overwhelmed part that still panics, the tired protector
        ...
        <p class="text-base md:text-lg leading-relaxed text-textsurface">
          ...
          clarity and compassion so the whole system can soften.
        </p>
      </section>
      ...
      <section class="mt-12 space-y-4">
        ...
        <p class="text-base md:text-lg leading-relaxed text-textsurface">
          ...
          more coherent centre of gravity.
        </p>
      </section>
      ...
      <section class="mt-12 space-y-4">
        ...
        <ul class="text-base md:text-lg leading-relaxed text-textsurface space-y-3 list-disc pl-5">
          ...
          <li>
            Clinicians, carers, and helpers who are over-carrying everyone else’s distress
            and quietly burning out.
          </li>
          <li>
            People who feel pulled between a harsh inner critic and a younger,
            frightened part that still panics or shuts down.
          </li>
          <li>
            People who can describe their patterns perfectly, but still can’t
            interrupt them in real life.
          </li>
        </ul>
